...
function BuscarContent() {
  ...
  const buscarArticulos = async (searchQuery: string, typeFilter: string) => {
    setIsLoading(true)
    try {
  ...
  // Título dinámico
  const tituloPagina = typeParam 
    ? `Artículos para ${typeParam.charAt(0).toUpperCase() + typeParam.slice(1)}` 
    ...
    <div className="min-h-screen bg-primary">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-2xl font-bold text-primary-foreground">{tituloPagina}</h1>
        </div>
        ...
        <p className="text-primary-foreground/70 mb-4">
            {isLoading ? "Cargando..." : `${resultados.length} resultados encontrados`}
        </p>
        ...
        {isLoading ? (
          ...
          <Card className="bg-secondary border-secondary p-8 text-center">
            ...
            <p className="text-primary-foreground/70 mb-4">Intenta ajustar tu búsqueda.</p>
