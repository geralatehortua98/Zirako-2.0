...
"[project]/Downloads/PRUEBAIA/app/api/items/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    // ... (Tu código existente del GET, sin cambios)
    try {
        const { id } = await params;
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT i.*, u.id AS vendedor_id, u.nombre AS nombre_vendedor, u.email AS email_vendedor, u.foto_perfil AS foto_vendedor, c.nombre AS nombre_categoria, c.id AS categoria_id
      FROM items i JOIN usuarios u ON i.usuario_id = u.id LEFT JOIN categorias c ON i.categoria_id = c.id WHERE i.id = ?`, [
            id
        ]);
        if (result.rows.length === 0) return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: "No encontrado"
        }, {
            status: 404
        ...
        const item = {
            ...result.rows[0],
            imagenes: typeof result.rows[0].imagenes === "string" ? JSON.parse(result.rows[0].imagenes) : result.rows[0].imagenes
        };
...
async function PUT(request, { params }) {
    // ... (Tu código existente del PUT para editar)
    // Solo asegúrate de que el query sea correcto, pero no necesitamos cambiarlo para el Soft Delete
    try {
        const { id } = await params;
        const userId = await getUserId(request);
        if (!userId) return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: "No autorizado"
        }, {
            status: 401
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE items SET titulo=COALESCE(?,titulo), descripcion=COALESCE(?,descripcion), precio=COALESCE(?,precio), estado=COALESCE(?,estado), ciudad=COALESCE(?,ciudad), condicion=COALESCE(?,condicion), tipo=COALESCE(?,tipo), categoria_id=COALESCE(?,categoria_id), imagenes=COALESCE(?,imagenes) WHERE id = ? AND usuario_id = ?`, [
            titulo,
            descripcion,
            precio,
            estado,
...
async function DELETE(request, { params }) {
    try {
        ...
        const itemCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT usuario_id FROM items WHERE id = ?", [
            id
        ]);
        ...
        // (Asegúrate de que el ENUM de estado en tu BD tenga 'cancelado' o 'eliminado', 
        // si no, usa 'cancelado' que ya existe en tu script SQL)
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE items SET estado = 'cancelado', activo = FALSE WHERE id = ?", [
            id
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4af3ae07._.js.map