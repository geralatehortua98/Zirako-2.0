...
"[project]/Downloads/zirako2.0/app/api/impacto/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const totalResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT 
       ...
       FROM impacto_ambiental WHERE usuario_id = ?`, [
        ...
        const desgloseResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT 
        tipo_accion,
        COUNT(*) AS cantidad,
       ...
       GROUP BY tipo_accion`, [
        ...
        // 3. Impacto por mes
        const mensualResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT 
       ...
       ORDER BY mes DESC`, [
        ...
        // 4. Últimas acciones
        const ultimasResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT ia.*, i.titulo AS nombre_item
...
async function POST(request) {
    try {
       ...
       VALUES (?, ?, ?, ?, ?)`, [
        ...
        const userResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT puntos FROM usuarios WHERE id = ?`, [
            payload.userId
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4fc795eb._.js.map