...
"[project]/Downloads/PRUEBAIA/app/api/usuarios/perfil/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        // 1. Obtener datos del usuario (VITAL - Si esto falla, falla todo)
        // Nota: Eliminamos campos que podrían no existir si no corriste el script de migración para evitar errores 500
        // Si tienes el script 03 corrido, puedes volver a agregar 'nombre_empresa' y 'nivel' en el SELECT
        const userResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT id, nombre, email, telefono, ciudad, direccion, foto_perfil, puntos, created_at 
       FROM usuarios WHERE id = ?`, [
        ...
        // Cálculo seguro de nivel
        const nivel = calcularNivel(usuario.puntos || 0);
        // Intentar leer campos opcionales si existen, sino usar defaults
        const nivelDB = usuario.nivel || nivel;
        const empresaDB = usuario.nombre_empresa || "";
        // 2. Obtener estadísticas (Bloque Seguro Try/Catch)
        let stats = {
            total_articulos: 0,
        ...
        try {
            const statsResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT 
            ...
            stats = {
                ...
                total_favoritos: Number(raw.total_favoritos) || 0
            };
        } catch (e) {
            console.error("Error calculando estadísticas:", e);
        }
        // 3. Obtener impacto ambiental (Bloque Seguro Try/Catch)
        let impacto = {
        ...
        try {
            const impactoResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT 
           ...
           FROM impacto_ambiental WHERE usuario_id = ?`, [
            ...
            console.error("Error calculando impacto:", e);
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: {
                ...usuario,
                nivel: nivelDB,
                nombre_empresa: empresaDB,
                nivel_nombre: obtenerNombreNivel(nivelDB),
        ...
        console.error("[API PERFIL] Error CRITICO:", error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
...
// ... (Resto del archivo igual: PUT, calcularNivel, etc.)
// Asegúrate de mantener las funciones auxiliares al final del archivo:
...
//# sourceMappingURL=%5Broot-of-the-server%5D__913ef6bf._.js.map