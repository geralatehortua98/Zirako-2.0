...
"[project]/Downloads/zirako2.0/app/api/items/mis-articulos/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SET SESSION sort_buffer_size = 1024 * 1024 * 4");
        } catch (e) {
    ...
    `;
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(sql, [
            userId
        ]);
        ...
        const items = Array.isArray(rows) ? rows.map((item)=>{
            let imagenesParsed = [];
            try {
                imagenesParsed = typeof item.imagenes === "string" ? JSON.parse(item.imagenes) : item.imagenes || [];
            } catch (e) {
                imagenesParsed = [];
            }
            return {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__af99a0c6._.js.map