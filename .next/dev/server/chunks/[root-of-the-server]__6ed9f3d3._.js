...
"[project]/Downloads/zirako2.0/app/api/solicitudes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const ventas = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT v.id, v.created_at, v.precio_final as valor, v.notas as mensaje, 'venta' as tipo,
        ...
        const donaciones = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT d.id, d.created_at, 0 as valor, d.mensaje, 'donacion' as tipo,
                i.titulo as item_titulo, i.imagenes as item_imagenes,
                u.nombre as solicitante_nombre
         FROM donaciones d
...
async function PUT(request) {
    try {
        ...
        if (accion === 'rechazar') {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE ${tabla} SET estado = 'cancelada' WHERE id = ?`, [
                id
            ]);
            return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
        ...
        if (accion === 'aceptar') {
            ...
            let co2 = 0;
            if (tipo === 'venta') {
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT * FROM ventas WHERE id = ?", [
                    id
                ]);
                solicitud = res.rows[0];
                puntos = 10;
                co2 = 1.0;
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE ventas SET estado = 'completada' WHERE id = ?", [
                    id
                ]);
            } else {
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT * FROM donaciones WHERE id = ?", [
                    id
                ]);
                solicitud = res.rows[0];
                puntos = 30;
                co2 = 3.0;
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE donaciones SET estado = 'completada' WHERE id = ?", [
                    id
                ]);
            }
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE items SET estado = 'completado' WHERE id = ?", [
                itemId
            ]);
            // =========================================================
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE ventas SET estado = 'cancelada' WHERE item_id = ? AND estado = 'pendiente' AND id != ?", [
                itemId,
                id
            ]);
            // Cancelar otras donaciones
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE donaciones SET estado = 'cancelada' WHERE item_id = ? AND estado = 'pendiente' AND id != ?", [
                itemId,
                id
            ]);
            // Cancelar intercambios que involucren este ítem
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE intercambios SET estado = 'cancelada' WHERE (item_ofrecido_id = ? OR item_solicitado_id = ?) AND estado = 'pendiente'", [
                itemId,
                itemId
            ]);
            // =========================================================
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6ed9f3d3._.js.map