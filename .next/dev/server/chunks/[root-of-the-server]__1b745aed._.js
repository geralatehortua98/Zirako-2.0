...
"[project]/Downloads/PRUEBAIA/app/api/exchanges/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        // Validar propiedad
        const itemOfrecido = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT usuario_id, titulo FROM items WHERE id = ?", [
            item_ofrecido_id
        ]);
        if (itemOfrecido.rows.length === 0 || Number(itemOfrecido.rows[0].usuario_id) !== Number(payload.userId)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: "El artículo ofrecido no es tuyo"
            }, {
                status: 403
            });
        }
        const itemSolicitado = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT usuario_id, titulo FROM items WHERE id = ?", [
            item_solicitado_id
        ]);
        if (itemSolicitado.rows.length === 0) return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: "Artículo no encontrado"
        }, {
            status: 404
        });
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO intercambios (item_ofrecido_id, item_solicitado_id, usuario_propone_id, usuario_recibe_id, mensaje, estado)
       VALUES (?, ?, ?, ?, ?, 'pendiente')`, [
            item_ofrecido_id,
            item_solicitado_id,
            payload.userId,
        ...
        // Notificación correo (opcional, try-catch para no bloquear)
        try {
            const userRecibe = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT email, nombre FROM usuarios WHERE id = ?", [
                itemSolicitado.rows[0].usuario_id
            ]);
            if (userRecibe.rows.length > 0) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$email$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendExchangeRequestEmail"])(userRecibe.rows[0].email, userRecibe.rows[0].nombre, itemSolicitado.rows[0].titulo, payload.name, itemOfrecido.rows[0].titulo);
            }
        } catch (e) {
        ...
        console.error("Error POST exchange", error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: "Error interno"
        }, {
...
async function PUT(request) {
    try {
        ...
        const resEx = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT * FROM intercambios WHERE id = ?", [
            id
        ]);
        ...
        // 2. Verificar que soy el receptor
        ...
        // 3. Actualizar estado del intercambio (con fecha si existe la columna, sino sin fecha para no romper)
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE intercambios SET estado = ?, fecha_respuesta = NOW() WHERE id = ?", [
                estado,
                id
            ]);
        } catch (e) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE intercambios SET estado = ? WHERE id = ?", [
                estado,
                id
            ]);
        }
        // 4. SI SE ACEPTA: Magia de Economía Circular
        if (estado === "aceptado" || estado === "completado") {
            // A) Dar de baja los ítems (Estado 'completado')
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE items SET estado = 'completado' WHERE id IN (?, ?)", [
                exchange.item_ofrecido_id,
                exchange.item_solicitado_id
            ]);
            // B) Asignar Puntos (20 pts c/u)
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE usuarios SET puntos = puntos + 20 WHERE id IN (?, ?)", [
                exchange.usuario_propone_id,
                exchange.usuario_recibe_id
            ]);
            // C) Registrar Impacto Ambiental (Esto llena el Dashboard)
            // Registramos para ambos usuarios (Propone y Recibe)
            const co2Ahorrado = 5.0; // Valor estimado por intercambio
            // Impacto para quien propuso
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO impacto_ambiental (usuario_id, item_id, tipo_accion, co2_ahorrado, descripcion) 
             VALUES (?, ?, 'intercambio', ?, 'Intercambio completado')`, [
                exchange.usuario_propone_id,
                exchange.item_ofrecido_id,
                co2Ahorrado
            ]);
            // Impacto para quien recibió (tú)
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO impacto_ambiental (usuario_id, item_id, tipo_accion, co2_ahorrado, descripcion) 
             VALUES (?, ?, 'intercambio', ?, 'Intercambio completado')`, [
                exchange.usuario_recibe_id,
                exchange.item_solicitado_id,
        ...
        console.error("Error PUT exchange", error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: error.message
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1b745aed._.js.map