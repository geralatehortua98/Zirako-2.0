...
"[project]/Downloads/PRUEBAIA/app/api/users/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        // --- NUEVO: Lógica para cargar lista de empresas recolectoras ---
        if (rol === 'empresa_recolectora') {
            // Buscamos usuarios con rol_id = 3 (Recolectores)
            // Seleccionamos id, nombre y nombre_empresa para el select del formulario
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT id, nombre, nombre_empresa FROM usuarios WHERE rol_id = 3");
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT id, email, nombre, telefono, ciudad, direccion, foto_perfil, puntos, rol_id, email_verificado, created_at
       FROM usuarios WHERE id = ?`, [
        ...
        const stats = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT 
...
async function PUT(request) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE usuarios SET 
...
//# sourceMappingURL=%5Broot-of-the-server%5D__22b3f81a._.js.map