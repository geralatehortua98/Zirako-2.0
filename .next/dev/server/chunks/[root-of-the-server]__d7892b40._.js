...
"[project]/Downloads/zirako2.0/app/api/users/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (rol === 'empresa_recolectora') {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT id, nombre, email 
             FROM usuarios 
             WHERE rol_id = 3`);
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT id, email, nombre, telefono, ciudad, direccion, foto_perfil, puntos, rol_id, email_verificado, created_at, nombre_empresa, nivel
       FROM usuarios WHERE id = ?`, [
        ...
        let stats = {};
        try {
            const statsRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT 
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d7892b40._.js.map