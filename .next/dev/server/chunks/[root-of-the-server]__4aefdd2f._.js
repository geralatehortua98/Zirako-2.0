...
"[project]/Downloads/PRUEBAIA/app/api/collections/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const isMisRecolecciones = searchParams.get('mis_recolecciones') === 'true';
        let sql = `
      SELECT 
        r.*, 
    ...
    `;
        const params = [];
        // Filtro inteligente: Si es empresa, ve las asignadas. Si es usuario, ve las suyas.
        // O si quiere ver todo el historial donde participa.
...
async function POST(request) {
    try {
        ...
        const codigoRecoleccion = `REC-${randomCode}`;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO recolecciones (usuario_id, recolector_id, codigo_recoleccion, direccion, ciudad, fecha_programada, horario_preferido, descripcion, tipo_material, estado)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'pendiente')`, [
            payload.userId,
            recolector_id,
            codigoRecoleccion,
        ...
        // Emails
        const empresaResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT email, nombre, nombre_empresa FROM usuarios WHERE id = ?", [
            recolector_id
        ]);
        if (empresaResult.rows[0]) {
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$email$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendCollectionConfirmationEmail"])(payload.email, payload.name, empresaResult.rows[0].email, empresaResult.rows[0].nombre_empresa, codigoRecoleccion, fechaProgramada, horario, direccion, ciudad, descripcion);
            } catch (e) {}
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
...
async function PUT(request) {
    try {
        ...
        // 1. Verificar permiso
        const recCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT * FROM recolecciones WHERE id = ?", [
            id
        ]);
        ...
        // 2. Actualizar estado
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE recolecciones SET estado = ? WHERE id = ?", [
            estado,
            id
        ]);
        // 3. SI SE COMPLETA: Dar puntos y registrar impacto PARA AMBOS
        if (estado === 'completada') {
            const puntosUsuario = 50;
            const puntosEmpresa = 30; // Puntos por servicio prestado
            const co2Ganado = 10.0;
            // A) Recompensa al USUARIO (Solicitante)
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE usuarios SET puntos = puntos + ? WHERE id = ?", [
                puntosUsuario,
                recoleccion.usuario_id
            ]);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO impacto_ambiental (usuario_id, tipo_accion, co2_ahorrado, descripcion) 
             VALUES (?, 'recoleccion', ?, ?)`, [
                recoleccion.usuario_id,
                co2Ganado,
                `Recolección ${recoleccion.codigo_recoleccion} completada`
            ]);
            // B) Recompensa a la EMPRESA (Recolector) - ¡ESTO FALTABA!
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE usuarios SET puntos = puntos + ? WHERE id = ?", [
                puntosEmpresa,
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO impacto_ambiental (usuario_id, tipo_accion, co2_ahorrado, descripcion) 
             VALUES (?, 'recoleccion', ?, ?)`, [
                recoleccion.recolector_id,
                co2Ganado,
                `Servicio de recolección ${recoleccion.codigo_recoleccion} realizado`
            ]);
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            message: "Estado actualizado y recompensas asignadas"
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4aefdd2f._.js.map