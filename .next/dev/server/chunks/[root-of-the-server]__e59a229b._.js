...
"[project]/Downloads/zirako2.0/app/api/collections/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function generarCodigoUnico() {
    ...
    while(existe){
        ...
        codigo = `REC-${random}`;
        const check = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT id FROM recolecciones WHERE codigo_recoleccion = ?", [
            codigo
        ]);
...
async function GET(request) {
    try {
        ...
        if (!payload) return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
...
async function POST(request) {
    try {
        ...
        if (!direccion || !fecha || !recolector_id) return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: "Faltan datos"
        }, {
            status: 400
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO recolecciones (usuario_id, recolector_id, codigo_recoleccion, direccion, ciudad, fecha_programada, horario_preferido, descripcion, tipo_material, estado)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'pendiente')`, [
            payload.userId,
            recolector_id,
            codigoRecoleccion,
            ...
            horario,
            descripcion,
            tipo_material || 'Mezclado'
        ]);
        // Notificación por correo
        const empresaResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT email, nombre FROM usuarios WHERE id = ?", [
            recolector_id
        ]);
        if (empresaResult.rows.length > 0) {
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$email$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendCollectionConfirmationEmail"])(payload.email, payload.name, empresaResult.rows[0].email, empresaResult.rows[0].nombre, codigoRecoleccion, fechaProgramada, horario, direccion, ciudad, descripcion);
            } catch (e) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            message: "Recolección programada",
            data: {
                id: codigoRecoleccion
            }
        }, {
            status: 201
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: "Error al programar: " + error.message
        }, {
            status: 500
        });
    }
...
async function PUT(request) {
    try {
        ...
        const recCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT * FROM recolecciones WHERE id = ?", [
            id
        ]);
        if (recCheck.rows.length === 0) return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: "No encontrado"
        }, {
            status: 404
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE recolecciones SET estado = ? WHERE id = ?", [
            estado,
            id
        ]);
        if (estado === 'completada') {
            // Puntos y CO2
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE usuarios SET puntos = puntos + 50 WHERE id = ?", [
                recoleccion.usuario_id
            ]);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO impacto_ambiental (usuario_id, tipo_accion, co2_ahorrado, descripcion) 
             VALUES (?, 'recoleccion', 10.0, ?)`, [
                recoleccion.usuario_id,
                `Recolección ${recoleccion.codigo_recoleccion} completada`
            ]);
            // Puntos para la empresa 
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE usuarios SET puntos = puntos + 30 WHERE id = ?", [
                recoleccion.recolector_id
            ]);
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e59a229b._.js.map