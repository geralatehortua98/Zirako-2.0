...
"[project]/Downloads/PRUEBAIA/app/api/items/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO items (usuario_id, categoria_id, titulo, descripcion, tipo, condicion, precio, ciudad, imagenes, estado)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'disponible')`, [
            finalUserId,
            catFinal,
            titulo,
        ...
        // NOTA: Se eliminó la línea de UPDATE usuarios SET puntos... 
        // Ahora los puntos se ganan al completar la acción.
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2c1461f8._.js.map