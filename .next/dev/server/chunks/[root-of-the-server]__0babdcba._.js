...
"[project]/Downloads/zirako2.0/app/api/auth/register/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { email, password, name, phone, ciudad, direccion, rol_id, tipo_documento, numero_documento } = body;
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerUser"])({
            email,
            password,
            name,
            phone,
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$email$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendWelcomeEmail"])(email, name);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0babdcba._.js.map