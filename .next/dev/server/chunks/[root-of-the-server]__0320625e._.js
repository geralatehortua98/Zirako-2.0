...
"[project]/Downloads/PRUEBAIA/app/api/solicitudes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        // Buscar Ventas Pendientes (Donde yo soy el vendedor)
        const ventas = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT v.id, v.created_at, v.precio_final as valor, v.notas as mensaje, 'venta' as tipo,
        ...
        // Buscar Donaciones Pendientes (Donde yo soy el donante)
        const donaciones = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT d.id, d.created_at, 0 as valor, d.mensaje, 'donacion' as tipo,
                i.titulo as item_titulo, i.imagenes as item_imagenes,
                u.nombre as solicitante_nombre
         FROM donaciones d
...
async function PUT(request) {
    try {
        ...
        const payload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyToken"])(token) // Yo soy el dueño (vendedor/donante)
        ;
        const body = await request.json();
        const { id, tipo, accion } = body // accion: 'aceptar' | 'rechazar'
        ;
        if (accion === 'rechazar') {
            const tabla = tipo === 'venta' ? 'ventas' : 'donaciones';
            // ✅ Guardamos fecha_respuesta al rechazar
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE ${tabla} SET estado = 'cancelada', fecha_respuesta = NOW() WHERE id = ?`, [
                id
            ]);
            return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
        ...
        if (accion === 'aceptar') {
            ...
            let co2 = 0;
            if (tipo === 'venta') {
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT * FROM ventas WHERE id = ?", [
                    id
                ]);
                solicitud = res.rows[0];
                puntos = 10;
                co2 = 1.0;
                // ✅ Guardamos fecha_respuesta al completar venta
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE ventas SET estado = 'completada', fecha_respuesta = NOW() WHERE id = ?", [
                    id
                ]);
            } else {
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT * FROM donaciones WHERE id = ?", [
                    id
                ]);
                solicitud = res.rows[0];
                puntos = 30;
                co2 = 3.0;
                // ✅ Guardamos fecha_respuesta al completar donación
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE donaciones SET estado = 'completada', fecha_respuesta = NOW() WHERE id = ?", [
                    id
                ]);
            }
            if (!solicitud) throw new Error("Solicitud no encontrada");
            // 2. Dar de baja el ítem (Economía Circular)
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE items SET estado = 'completado' WHERE id = ?", [
                solicitud.item_id
            ]);
            // 3. Asignar puntos al dueño (Yo)
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE usuarios SET puntos = puntos + ? WHERE id = ?", [
                puntos,
                payload.userId
            ]);
            // 4. Registrar Impacto Ambiental
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO impacto_ambiental (usuario_id, item_id, tipo_accion, co2_ahorrado, descripcion)
                ...
                tipo,
                co2,
                `${tipo === 'venta' ? 'Venta' : 'Donación'} completada vía solicitud`
            ]);
            return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
                message: "¡Felicidades! Ciclo completado."
            });
        }
    } catch (error) {
        console.error(error);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0320625e._.js.map