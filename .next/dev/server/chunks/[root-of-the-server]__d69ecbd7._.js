...
"[project]/Downloads/zirako2.0/app/api/contactar/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (!mensaje) return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
        ...
        if (userId) {
            try {
                const userRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT nombre, email FROM usuarios WHERE id = ?", [
                    userId
                ]);
        ...
        let itemInfo = null;
        if (itemId) {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT * FROM items WHERE id = ?", [
                itemId
            ]);
        ...
        if (userId && itemInfo && Number(userId) !== Number(itemInfo.usuario_id)) {
            if (tipo === 'compra') {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO ventas (vendedor_id, comprador_id, item_id, precio_final, estado, notas) 
                 VALUES (?, ?, ?, ?, 'pendiente', ?)`, [
                    itemInfo.usuario_id,
                    userId,
                    itemId,
            ...
            // ---------------------------------------------------------------------
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO donaciones (donante_id, receptor_id, item_id, estado, mensaje) 
                 VALUES (?, ?, ?, 'pendiente', ?)`, [
                    itemInfo.usuario_id,
                    userId,
                    itemId,
        ...
        // 4. ENVIAR CORREOS
        if (tipo === 'donacion') {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$email$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendDonationRequestEmail"])(sellerEmail, sellerName, itemName, contactadorNombre, contactadorEmail, mensaje);
        } else if (tipo === 'compra') {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$email$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendPurchaseProposalEmail"])(sellerEmail, sellerName, itemName, contactadorNombre, contactadorEmail, mensaje);
        } else {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$email$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendEmail"])({
                to: sellerEmail,
        ...
        if (userId && itemInfo) {
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO mensajes (remitente_id, destinatario_id, item_id, contenido) VALUES (?, ?, ?, ?)`, [
                    userId,
                    itemInfo.usuario_id,
                    itemId,
                    mensaje
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$zirako2$2e$0$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            message: "Solicitud registrada y enviada"
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d69ecbd7._.js.map