...
"[project]/Downloads/PRUEBAIA/app/api/contactar/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        // 1. OBTENER DATOS DEL REMITENTE (TÚ) DESDE LA BASE DE DATOS
        // Esto es lo que faltaba para que no salga "undefined"
        if (userId) {
            try {
                const userRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT nombre, email FROM usuarios WHERE id = ?", [
                    userId
                ]);
        ...
        let itemInfo = null;
        if (itemId) {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT * FROM items WHERE id = ?", [
                itemId
            ]);
            if (res.rows.length > 0) itemInfo = res.rows[0];
        }
        // 3. INSERTAR EN BASE DE DATOS (SOLICITUD)
        if (userId && itemInfo && Number(userId) !== Number(itemInfo.usuario_id)) {
            if (tipo === 'compra') {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO ventas (vendedor_id, comprador_id, item_id, precio_final, estado) 
                 VALUES (?, ?, ?, ?, 'pendiente')`, [
                    itemInfo.usuario_id,
                    userId,
                    itemId,
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO donaciones (donante_id, receptor_id, item_id, estado, mensaje) 
                 VALUES (?, ?, ?, 'pendiente', ?)`, [
                    itemInfo.usuario_id,
                    userId,
                    itemId,
        ...
        // 4. ENVIAR CORREOS (Ahora usará las variables correctas)
        if (tipo === 'donacion') {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$email$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendDonationRequestEmail"])(sellerEmail, sellerName, itemName, contactadorNombre, contactadorEmail, mensaje);
        } else if (tipo === 'compra') {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$email$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendPurchaseProposalEmail"])(sellerEmail, sellerName, itemName, contactadorNombre, contactadorEmail, mensaje);
        } else {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$email$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendEmail"])({
                to: sellerEmail,
        ...
        if (userId && itemInfo) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO mensajes (remitente_id, destinatario_id, item_id, contenido) VALUES (?, ?, ?, ?)`, [
                userId,
                itemInfo.usuario_id,
                itemId,
                mensaje
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eb85fa06._.js.map