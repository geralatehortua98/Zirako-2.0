...
"[project]/Downloads/PRUEBAIA/app/api/auth/register/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        // Nota: rol_id debe ser un número. Si viene null, se asigna 1 (Persona) por defecto en la función registerUser
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerUser"])({
            email,
            password,
            name,
            phone,
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$PRUEBAIA$2f$lib$2f$email$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendWelcomeEmail"])(email, name);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cb713bd4._.js.map